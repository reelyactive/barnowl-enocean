...
const ESPDecoder = require('./espdecoder.js');


/**
 * BarnowlEnOcean Class
 * Converts EnOcean decodings into standard raddec events.
 * @param {Object} options The options as a JSON object.
 */
class BarnowlEnOcean extends EventEmitter {

  /**
   * BarnowlEnOcean constructor
   * @param {Object} options The options as a JSON object.
   * @constructor
   */
  constructor(options) {
    ...
    this.listeners = [];
    this.espDecoder = new ESPDecoder(options);
  }
  ...
  addListener(ListenerClass, options) {
    options = options || {};
    options.decoder = this.espDecoder;
